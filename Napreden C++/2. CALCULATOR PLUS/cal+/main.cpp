...
Main:
    {
        ...
        third, dayEntered, dayEnteredOriginal, DayInMonthCheck, chsInYear, chsInYear2, yearMain, monthMain, yearCompare, monthCompare, cmpr = 4, LeapYearCode = 0, MonthCode = 0, YearCode=0, CenturyCode=0, dayDiferanceOriginal, chsHere5;
            ...
            /* for unit conversion */
            long long int chsU, Unit, numCount; string UnitPrefix, UnitPrefix2;
            long_double_t conv[6]={1,10,100,1000,1000000,1000000000}, baseUnit = 0.00, sumU = 0.00, sumUoriginal = 0.00, uEnter[1000], nU;
        ...
        cout<<" (1) - METRIC UNIT CONVERTOR  - (1) "<<endl;
    ...
    if(chsMain == 1)
    {
        ...
        cout<<" (1) - METERS  - (1) "<<endl;
        cout<<" (2) - GRAMS   - (2) "<<endl;
        cout<<" (3) - LITRES  - (3) "<<endl;
        cout<<" (4) - AMPERES - (4) "<<endl;
        cout<<" (5) - KELVIN  - (5) "<<endl;
        cout<<" (6) - MOL     - (6) "<<endl;
        cout<<" (7) - CANDELE - (7) "<<endl;
        cout<<" (8) - SECONDS - (8) "<<endl;
        cout<<endl<<" Enter:"; cin>>chsU;
        while(cin.fail()){error(); cin>>chsU;}
        while(chsU > 8 || chsU < 1){ cout<<endl<<" Enter valid option: "; cin>>chsU;
        while(cin.fail()){error(); cin>>chsU;}}

        if(chsU == 1 ){ UnitPrefix = "METER";   UnitPrefix2 = "MEGAMETER";   }
        if(chsU == 2 ){ UnitPrefix = "GRAM";    UnitPrefix2 = "TONNE";       }
        if(chsU == 3 ){ UnitPrefix = "LITRE";   UnitPrefix2 = "TONNE";       }
        if(chsU == 4 ){ UnitPrefix = "AMPER";   UnitPrefix2 = "MEGAAMPER";   }
        if(chsU == 5 ){ UnitPrefix = "KELVIN";  UnitPrefix2 = "MEGAKELVIN";  }
        if(chsU == 6 ){ UnitPrefix = "MOL";     UnitPrefix2 = "MEGAMOL";     }
        if(chsU == 7 ){ UnitPrefix = "CANDELE"; UnitPrefix2 = "MEGACANDELE"; }
        if(chsU == 8 ){ UnitPrefix = "SECOND";  UnitPrefix2 = "MEGASECOND";  }

        system("cls"); cout<<" UNIT CONVERTOR "<<checkerGet2<<endl; cout<<endl;
        cout<<" (1)  - GIGA"<<UnitPrefix<<"   - (1) "<<endl;
        cout<<" (2)  - "<<UnitPrefix2<<"      - (2) "<<endl;
        cout<<" (3)  - KILO"<<UnitPrefix<<"   - (3) "<<endl;
        cout<<" (4)  - HECTO"<<UnitPrefix<<"  - (4) "<<endl;
        cout<<" (5)  - DECA"<<UnitPrefix<<"   - (5) "<<endl;
        cout<<" (6)  - "<<UnitPrefix<<"       - (6) "<<endl;
        cout<<" (7)  - DECI"<<UnitPrefix<<"   - (7) "<<endl;
        cout<<" (8)  - CENTI"<<UnitPrefix<<"  - (8) "<<endl;
        cout<<" (9)  - MILLI"<<UnitPrefix<<"  - (9) "<<endl;
        cout<<" (10)  - MICRO"<<UnitPrefix<<" - (10) "<<endl;
        cout<<" (11) - NANO"<<UnitPrefix<<"   - (11) "<<endl;
        cout<<endl<<" Enter:"; cin>>Unit;
        while(cin.fail()){error(); cin>>Unit;}
        while(Unit > 10 || Unit < 1){ cout<<endl<<" Enter valid option: "; cin>>Unit;
        while(cin.fail()){error(); cin>>Unit;}}

        Sleep (750); system("cls");
        cout<<" UNIT CONVERTOR "<<checkerGet2<<endl; cout<<endl;
        cout<<endl<<" ENTER HOW MANY NUMBERS YOU WILL BE ENTERING:"; cin>>nU;
        while(cin.fail()){error(); cin>>nU;}
        system ("cls");
        cout<<" UNIT CONVERTOR "<<checkerGet2<<endl; cout<<endl;
                ...
                cin>>uEnter[i];
                while(cin.fail()){error(); cin>>uEnter[i];}
                sumU+=uEnter[i];
                }
        ...
        if(Unit < 6 ) { sumU *= conv[6 - Unit]; } if(Unit > 6 ) { sumU /= conv[Unit - 6]; } if(Unit == 6 ) { sumU *= conv[0]; }
        for(int i = 0; i<5; i++ ){ cout<<setprecision(50)<<sumU * conv[i]<<endl; } for(int i = 6; i<11; i++ ){ numCount++; cout<<setprecision(50)<<sumU / conv[numCount]<<endl; }
