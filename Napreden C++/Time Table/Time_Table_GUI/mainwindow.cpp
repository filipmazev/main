...
QString path(string image)
{
    ...
    string pathTest = "C:" + string(slash) + "Users" + string(slash) + string(name.toStdString().c_str()) + string(slash) + "Documents" + string(slash) + "Time_Table_GUI" + string(slash) + string(image);
