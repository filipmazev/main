...
function sendMessageModal(){
    ...
    var ContactButtonModal = document.getElementById('modal-form-button'); ContactButtonModal.innerHTML = ModalButtonMessage2;
    setTimeout(function(){ ContactButtonModal.innerHTML = ModalButtonMessage1; }, 1300);

    var modalSelect = document.querySelector(".modal"); modalSelect.classList.add("modal-success");
    setTimeout(function(){ if(document.querySelector(".modal-success") !== null){ modalSelect.classList.remove("modal-success"); } }, 7000);
}
