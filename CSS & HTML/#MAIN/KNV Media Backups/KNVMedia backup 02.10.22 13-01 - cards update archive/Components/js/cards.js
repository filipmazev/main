...
modal.classList.add('modalActive'); overlay.classList.add('modalActive'); document.querySelectorAll('.modal-backdrop').forEach(function changeMode(item) { item.classList.add('modalActive'); }); }
